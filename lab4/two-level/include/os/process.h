...
typedef struct PCB {
  ...
  uint32*	pagetable[((MEM_MAX_VIRTUAL_ADDRESS + 1) >> MEM_L1FIELD_FIRST_BITNUM)]; // Statically allocated page table
...
//---------------------------------------------------------
#define PROCESS_PAGETABLE_NUMENTRIES (uint32)((MEM_MAX_VIRTUAL_ADDRESS + 1) / MEM_PAGESIZE)
