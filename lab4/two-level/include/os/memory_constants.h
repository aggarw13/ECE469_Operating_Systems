...
#define MEM_L2TABLE_SIZE (0x1 << (MEM_L1FIELD_FIRST_BITNUM - MEM_L2FIELD_FIRST_BITNUM))
#define MEM_ADDRESS_OFFSET_MASK (MEM_PAGESIZE - 1) 

#define MEM_ADDR_PAGENUM_MASK ~MEM_ADDRESS_OFFSET_MASK

#define MEM_L2_PAGENUM_MASK 0x000000FF
#define MEM_L1_BITS_MASK 0x300000
#define MEM_L2_BITS_MASK 0x0FF000

#define MEM_MAX_PHYS_MEM (0x1 << 21) 
#define MEM_MAX_PAGES MEM_MAX_PHYS_MEM >> MEM_L2FIELD_FIRST_BITNUM

#define MEM_PTE_MASK ~(MEM_PTE_READONLY | MEM_PTE_DIRTY | MEM_PTE_VALID) 

#define MEM_MAX_L2_PAGETABLES 256
